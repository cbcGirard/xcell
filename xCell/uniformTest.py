...
showGraphs=True
fname="Results/cube/tableVoltage.csv"
...
vMode=True
# def runUniformGrid(nDiv,elType,xmax,showGraphs,vMode=False):
...
if vMode:
    setup.addVoltageSource(1,index=sourceIndex)
else:
...
# runUniformGrid(nDiv, elType, xmax, True,True)

# for ii in np.logspace(-6,2):
#     runUniformGrid(nDiv, elType, ii,showGraphs=False)