...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_Common.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_Common.py:


Common resources for simulations.

.. GENERATED FROM PYTHON SOURCE LINES 6-641
...
.. _sphx_glr_download_auto_examples_Common.py:
